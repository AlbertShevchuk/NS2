...
$ns duplex-link $node5 $node3 2Mb 10ms DropTail 
...
$ns duplex-link-op $node5 $node3 orient right-right
...
# Third TCP traffic source
# create the third TCP agent and attach it to node node5
set tcp3 [new Agent/TCP]
$ns attach-agent $node5 $tcp3
$tcp3 set fid_ 3		# blue color
$tcp3 set class_ 3
